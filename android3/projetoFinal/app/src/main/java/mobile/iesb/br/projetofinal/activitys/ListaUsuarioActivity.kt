...
class ListaUsuarioActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var usuario:Usuario
        usuarioRef.child("usuarios").orderByChild("nome").addValueEventListener(object: ValueEventListener {
...
class UsuarioListAdapter(paramContexto: Context, paramNoticias: List<Usuario>) : RecyclerView.Adapter<UsuarioViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UsuarioViewHolder {
        val contentHomeitemView = LayoutInflater.from(this.contexto).inflate(R.layout.content_lista_usuario, parent, false)
    ...
    override fun onBindViewHolder(holder: UsuarioViewHolder, position: Int) {
        ...
        holder.textViewNomeUsuario.text = item.nome
        holder.textViewEmailUsuario.text = item.email
...
class UsuarioViewHolder(contentView: View) : RecyclerView.ViewHolder(contentView) {
    ...
    var textViewNomeUsuario: TextView
    var textViewEmailUsuario: TextView
    var _contentView:View

    init{

        textViewNomeUsuario = contentView.findViewById(R.id.textViewNomeUsuario)
